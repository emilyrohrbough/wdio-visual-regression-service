...
describe('LocalCompare', function () {
  ...
  context('processScreenshot', function () {
    ...
    it('does not update the reference image when changes are in tolerance', async function () {
      ...
      // check image results
      // const imageResult = Object.assign({}, this.resultIdentical, { isNewScreenshot: false });
      const imageResult = this.resultIdentical;

      console.log(resultFirst)
      console.log(this.resultIdentical)
      assert.deepEqual(resultFirst, imageResult, 'Result should be reported');
    ...
    //   // check image results
    //   const imageResult = Object.assign({}, this.resultIdentical, { isNewScreenshot: true });
    //   assert.deepEqual(resultFirst, imageResult, 'Result should be reported');
